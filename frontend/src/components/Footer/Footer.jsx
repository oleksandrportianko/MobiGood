   ...
   return (
      <div className="footer-wrapper p-0 m-0">
         <Container className="p-0">
            <Row className="pt-2 pb-3 m-0 d-flex flex-column flex-sm-row">
               <Col className="text-center mb-3 mb-sm-0">
                  <p className="footer-title m-0 mb-1 mb-lg-3">Соцмережі</p>
               ...
               <Col>
                  <Nav className="d-flex flex-column mb-3 mb-sm-0 text-center">
                     <p className="footer-title m-0 mb-sm-1 mb-lg-3">Інформація про нас</p>
               ...
               <Col>
                  <Nav className="d-flex flex-column mb-3 mb-sm-0 text-center">
                     <p className="footer-title m-0 mb-sm-1 mb-lg-3">Допомога</p>
               ...
               <Col >
                  <Nav className="d-flex flex-column mb-3 mb-sm-0 text-center">
                     <p className="footer-title m-0 mb-sm-1 mb-lg-3">Партнери</p>
